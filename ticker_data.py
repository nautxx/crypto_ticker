class TickerData:
    ...
    """
    def __init__(self, currency_symbol, price, last_update, twenty_four_hour_low, twenty_four_hour_high, twenty_four_hour_change, twenty_four_hour_change_pct, hour_change, hour_change_pct, supply):
